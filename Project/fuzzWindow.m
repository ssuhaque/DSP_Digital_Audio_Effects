function varargout = fuzzWindow(varargin)
% FUZZWINDOW Application M-file for fuzzWindow.fig
%    FIG = FUZZWINDOW launch fuzzWindow GUI.
%    FUZZWINDOW('callback_name', ...) invoke the named callback.

% Last Modified by GUIDE v2.0 28-Aug-2004 19:43:41
...
set(handles.gain,'String',num2str(4));
upDate(handles);
