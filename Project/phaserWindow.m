function varargout = phaserWindow(varargin)
% PHASERWINDOW Application M-file for phaserWindow.fig
%    FIG = PHASERWINDOW launch phaserWindow GUI.
%    PHASERWINDOW('callback_name', ...) invoke the named callback.

% Last Modified by GUIDE v2.0 28-Aug-2004 19:45:10
...
clc;
set(handles.window,'String',num2str(192));
set(handles.pass,'String',num2str(1));
set(handles.mix,'String',num2str(0.5));
set(handles.feedback,'String',num2str(-0.7));
set(handles.cFrequency,'String',num2str(15));
set(handles.bandwidth,'String',num2str(1));
set(handles.depth,'String',num2str(6));
...
FB= str2double( get(handles.feedback,'String') );
Bw= str2double( get(handles.bandwidth,'String') );
...
y=phaser(x, window, mix, Fc, Fs, Bw, FB, depth ,pass);
...
% --------------------------------------------------------------------
function varargout = feedback_Callback(h, eventdata, handles, varargin)
% --------------------------------------------------------------------
