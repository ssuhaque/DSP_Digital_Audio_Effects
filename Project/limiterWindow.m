function varargout = limiterWindow(varargin)
% LIMITERWINDOW Application M-file for limiterWindow.fig
%    FIG = LIMITERWINDOW launch limiterWindow GUI.
%    LIMITERWINDOW('callback_name', ...) invoke the named callback.

% Last Modified by GUIDE v2.0 28-Aug-2004 19:43:59
...
set(handles.LT,'String',num2str(1));
set(handles.LS,'String',num2str(1));
set(handles.tRT,'String',num2str(0.1));
set(handles.tAT,'String',num2str(0.01));
set(handles.tH,'String',num2str(0.1));
set(handles.UTH,'String',num2str(0.5));
set(handles.LTH,'String',num2str(0.4));
upDate(handles);

[x,map]=imread('limiter','bmp');
...
y = Limiter(x,T,LT,LS,tRT,tAT,tHT,UTH,LTH,Fs,Hoption,Hs);
...
% --------------------------------------------------------------------
function varargout = Hs_Callback(h, eventdata, handles, varargin)
% --------------------------------------------------------------------
