function varargout = noiseWindow(varargin)
% NOISEWINDOW Application M-file for noiseWindow.fig
%    FIG = NOISEWINDOW launch noiseWindow GUI.
%    NOISEWINDOW('callback_name', ...) invoke the named callback.

% Last Modified by GUIDE v2.0 28-Aug-2004 19:44:18
...
set(handles.NT,'String',num2str(1));
set(handles.NS,'String',num2str(1));
...
set(handles.pole,'String',num2str(0.98));
upDate(handles);

[x,map]=imread('noiseGate','bmp');
...
y = Noise_gate(x,T,NT,NS,tRT,tAT,tH,UTH,LTH,Fs,Hoption,env,pole);
...
% --------------------------------------------------------------------
function varargout = NT_Callback(h, eventdata, handles, varargin)
% --------------------------------------------------------------------
