function varargout = tremoloWindow(varargin)
% TREMOLOWINDOW Application M-file for tremoloWindow.fig
%    FIG = TREMOLOWINDOW launch tremoloWindow GUI.
%    TREMOLOWINDOW('callback_name', ...) invoke the named callback.

% Last Modified by GUIDE v2.0 28-Aug-2004 19:46:24
...
set(handles.amplitude,'String',num2str(0.2));
set(handles.frequency,'String',num2str(1.27));
upDate(handles);
